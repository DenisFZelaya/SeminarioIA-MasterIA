    ...
    <div>
      ...
      >
        <div
          ...
          className="relative bg-gray-800 rounded-lg overflow-hidden border border-cyan-500/30 shadow-lg hover:shadow-cyan-500/20 hover:border-cyan-500/50"
        >
          ...
          <div className="p-4">
            <h3 className="text-lg font-medium text-cyan-300 mb-1 truncate">
              {movie.title}
            </h3>
      ...
      <div style={{ width: "100%" }}>
        <a
          style={{ width: "100%" }}
          target="_blank"
          href={`https://www.imdb.com/es-es/title/tt${movie?.imdbId}/`}
          className="text-xs py-1 px-3  rounded border border-purple-500/30 text-purple-400 hover:bg-purple-500/20 transition-all duration-300"
        >
          Detalles
        </a>
      </div>
