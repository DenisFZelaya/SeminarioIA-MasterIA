...
export default function Login() {
  ...
  return (
    <div
      className="flex w-full flex-col lg:flex-row min-h-screen bg-gray-900"
      style={{ width: "100vw" }}
    >
      {/* Columna de Login */}
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              ...
              <p className="text-cyan-300/70 text-xs lg:text-sm tracking-widest uppercase">
                Creación de sistema de recomendación de películas con base al
                perfil del usuario
              </p>
            </div>
            ...
            <div>
              <button
                type="button"
                disabled={isLoading}
                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-black bg-gradient-to-r from-cyan-400 to-cyan-300 hover:from-cyan-500 hover:to-cyan-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-all duration-300 ${
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-4/5 h-4/5">
            ...
            <div
              className="absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full border-2 border-purple-500/40 animate-pulse"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-cyan-300/70 max-w-md">
                Desarrollamos un sistema de recomendación de películas con IA,
                que personaliza sugerencias según el perfil del usuario mediante
                filtrado colaborativo, basado en contenido.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-16 h-16 border border-cyan-500/30 rounded-md flex items-center justify-center"
                  >
